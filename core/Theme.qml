...
QtObject {
  ...
  property color primary: "#c0c7d4"
  property color primaryFg: "#2a313b"
  property color secondary: "#c5c6cc"
  property color tertiary: "#ddc1b4"
  property color backgroundFg: "#e5e2e2"
  property color surfaceFg: "#e5e2e2"
  property color surfaceVariantFg: "#c5c6cb"
  property color outline: "#8f9196"
